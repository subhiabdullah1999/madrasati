...
class Routes {
  ...
  static String previousRoute = splash;
  ...
  static Route<dynamic> onGenerateRouted(RouteSettings routeSettings) {
    ...
    switch (routeSettings.name) {
      ...
      case childFees:
        {
          return ChildFeesScreen.route(routeSettings);
        }

      case childFeeDetails:
        {
          return ChildFeeDetailsScreen.route(routeSettings);
        }

      case confirmPayment:
        {
          return ConfirmPaymentScreen.route(routeSettings);
        }
      case transactions:
        {
          return TransactionsScreen.route(routeSettings);
        }

      case schoolGallery:
        {
          return SchoolGalleryScreen.route(routeSettings);
        }

      case galleryDetails:
        {
          return GalleryDetailsScreen.route(routeSettings);
        }
      case galleryImages:
        {
          return GalleryImagesScreen.route(routeSettings);
        }
